...
function TutorProfile() {
  ...
  const { availableTime } = useAvailableTimeByTimeKeyQuery(
    {
      timeKey: formatDateToYYYYMMDD(date),
      tutorId: tutorId || "",
    },
    {
      skip: !account,
  ...
  return (
    <>
      {isShowCreateCourse && (
        <Backdrop
          isShow={isShowCreateCourse}
          setIsShow={setIsShowCreateCourse}
          children={<CourseForm />}
        />
      )}
      <div className="bg-gray-100">
        <div className="container mx-auto py-8">
          <div className="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            ...
            <div className="col-span-4 sm:col-span-6 space-y-5">
              <div className="bg-white shadow rounded-lg p-6">
                  ...
                  <div className="flex space-x-2 my-2">
                    <Button
                      ...
                      onClick={() => {
                        ...
                        const createSchedules = timeKeys?.map((timeKey) => {
                          return {
                            time_key: timeKey,
                            is_available: true,
                          };
                        ...
                        createAvailabilityTime({
                          availability_schedules: {
                            availabilities: updateSchedules,
                          },
                        });
                      }}
                    />
