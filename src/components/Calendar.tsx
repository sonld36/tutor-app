  ...
  return (
    ...
    <>
      <button
        ...
        ref={buttonRef}
        onClick={openModal}
        data-popover-target="timepicker-modal"
      ...
      {isOpen && (
        <div
          data-popover="timepicker-modal"
          ref={modalRef}
          tabIndex={-1}
          className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-fit md:inset-0 h-[calc(100%-1rem)] max-h-full"
        >
          <div className="relative p-4 w-full max-w-[23rem] max-h-full bg-white">
            {/* <!-- Modal content --> */}
            <DateTime />
